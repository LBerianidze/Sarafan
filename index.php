            ...
            <div class="row">
                <div class="col-xl-2 col-lg-3 col-md-4 sidebar fixed-top">
                    <a href="#" class="navbar-brand text-white d-block mx-auto text-center py-3 mb-4 bottom-border">Панель
                        управления</a>
                    <ul class="navbar-nav flex-column mt-4 nav" role="tablist">
                        <li class="nav-item">
                            <a class="sidebar-link nav-link text-white p-3 mb-2 active" id="nav-users-tab" data-toggle="tab" href="#nav-users"><i class="fas fa-users text-light fa-lg mr-3"></i>
                                Пользователи</a>
                        </li>
                        <li class="nav-item">
                            <a class="sidebar-link nav-link text-white p-3 mb-2" id="nav-statistics-tab" data-toggle="tab" href="#nav-statistics"><i class="fas fa-database text-light fa-lg mr-3"></i>
                                Статистика</a>
                        </li>
                        <li class="nav-item">
                            <a class="sidebar-link nav-link text-white p-3 mb-2" id="nav-filtered-users-tab" data-toggle="tab" href="#nav-filtered-users"><i class="fas fa-comment-dots text-light fa-lg mr-3"></i>
                                Отправка сообщений</a>
                        </li>
                        <li class="nav-item">
                            <a class="sidebar-link nav-link text-white p-3 mb-2" id="nav-texts-tab" data-toggle="tab" href="#nav-texts"><i class="fas fa-font text-light fa-lg mr-3"></i>
                                Тексты</a>
                        </li>
                    </ul>
                </div>
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-footer row">
                ...
                <button type="button" class="btn btn-success col-12 col-lg-3 mx-auto" data-dismiss="modal">
                    Закрыть
                </button>
            </div>
        </div>
...
<div class="modal fade" id="show-send-message">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title">Отправить сообщение выбранным пользователям</h4>
                <button type="button" class="close" data-dismiss="modal">&times;</button>
            </div>
            <textarea class="form-control" rows="30" id="send_message_body"></textarea>
            <button type="button" class="btn btn-success col-12 col-lg-5 mx-auto my-1" id="send-message">Отправить</button>
        </div>
    </div>
</div>
<div class="tab-content" id="nav-tabContent">
                        ...
                        <div class="row align-items-center">
                            <div class="col-xl-8 col-12 mb-4 mb-xl-0">
                                <div class="row">
                                    <div class='form-group col-3 col-sm-3 col-md-3 col-lg-3 col-lg-3'>
                                        <select class="form-control" onchange="changeGroupType(this.selectedIndex);" aria-expanded="true">
                                    ...
                                    <h3 class="text-muted text-center mb-3 col-9 col-sm-9 col-md-9 col-lg-9 col-lg-9">
                                        Список пользователей</h3>
                                        <h6 class="text-muted col-12">Кол-во пользователей: <span id="users_total_count">1</span></h6>
                                        <h6 class="text-muted col-12">Кол-во пользователей за вчера: <span id="users_total_count_yesterday">5</span></h6>
                                        <h6 class="text-muted col-12">Кол-во пользователей за сегодня: <span id="users_total_count_today">5</span></h6>
                                </div>
                                <div class='table-responsive'>
                                    <table class="table table-hover bg-light text-center" id='users_table'>
                                        ...
                                        <tr class="text-muted">
                                            <th>#</th>
                                            <th class="d-none">Telegram ID</th>
                                            <th>Username</th>
                                            <th>Телефон</th>
                                            <th>Имя</th>
                                ...
                                <nav class="row justify-content-center">
                                    <ul class="pagination justify-content-end col-4">
                                        <li class="page-item">
                                            <a class="page-link py-2 px-3" style="user-select: none"> <span>«</span>
                                            </a>
                                        </li>
                                    ...
                                    <div class="col-4 py-2">
                                        <span id='current_index_span'>1</span> <span>of</span>
                            ...
                            <div class="col-xl-4 col-12 align-self-start bg-light card-common rounded p-4 my-xl-5">
                                <div class="form-group row align-items-center">
                                    ...
                                    <input type="email" class="form-control col" id="username_input" aria-describedby="emailHelp" placeholder="Введите имя пользователя">
                                    <button type="submit" class="btn btn-primary btn-lg btn-block my-1" id='get-user-info-button'>
    ...
    <div class="tab-pane fade" id="nav-statistics"><!-- modal -->
        <section>
            <div class="container-fluid">
                <div class="row mb-5 pt-md-5">
                    <div class="col-xl-10 col-lg-9 col-md-12 ml-auto">
    ...
    <div class="tab-pane fade" id="nav-filtered-users">
        <section>
            <div class="container-fluid">
                <div class="row mb-5 pt-md-5">
                    <div class="col-xl-10 col-lg-9 col-md-12 ml-auto">
                        <div class="row align-items-center">
                            <div class="col-xl-12 col-12 mb-4 mb-xl-0">
                                <div class="row">
                                    <div class='form-group col-3 col-sm-3 col-md-3 col-lg-3 col-lg-3'>
                                        <button type="submit" class="btn btn-primary btn-block my-1" id='open-send-message-button'>
                                            Отправить сообщение
                                        </button>
                                    </div>
                                    <h3 class="text-muted text-center mb-3 col-9 col-sm-9 col-md-9 col-lg-9">
                                        Отправка сообщений</h3>
                                </div>
                                <div class='table-responsive'>
                                    <table class="table table-hover bg-light text-center" id='filtered_users_table'>
                                        <thead class=thead-light>
                                        <tr class="text-muted">
                                            <th><input type="checkbox" class="users_table_check" checked></th>
                                            <th>Telegram ID</th>
                                            <th>Username</th>
                                            <th>Телефон</th>
                                            <th>Имя</th>
    ...
    <div class="tab-pane fade" id="nav-texts"><!-- modal -->
        <section>
            <div class="container-fluid">
                <div class="row mb-5 pt-md-5">
                    <div class="col-xl-10 col-lg-9 col-md-12 ml-auto">
                        <div class="row align-items-center">
                            <div class="col-xl-12 col-12 mb-4 mb-xl-0">
                                ...
                                <div class='form-group'>
                                    ...
                                    <button onclick="save();" class="btn btn-primary btn-lg btn-block my-1">Сохранить
                                    </button>
                                </div>
                            </div>
                        </div>
